...
class Test_bann(unittest.TestCase):
    ...
    def test_nn_basics(self):
        print("\nTesting basic nearest neighbor searches...")
    ...
    def test_knn(self):
        print("\nTesting k-nearest neighbor searches in higher dimensions...")
    ...
    def test_bh_basics(self):
        print("\nTesting basic Bregman--Hausdorff divergence computations...")
    ...
    def test_bh(self):
        print("\nTesting Bregman--Hausdorff divergences in higher dimensions...")
